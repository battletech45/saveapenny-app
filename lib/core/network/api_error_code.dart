enum ApiErrorCode {
  ...
  invalidCreditCardDetails('INVALID_CREDIT_CARD_DETAILS'),
  invalidCreditCardPayment('INVALID_CREDIT_CARD_PAYMENT'),
  creditCardDetailsNotFound('CREDIT_CARD_DETAILS_NOT_FOUND'),
  conflict('CONFLICT'),
