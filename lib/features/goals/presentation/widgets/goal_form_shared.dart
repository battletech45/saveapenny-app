...
class GoalSheetFailureNotice extends StatelessWidget {
  const GoalSheetFailureNotice({super.key, required this.failure});
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      ...
      child: Padding(
        ...
        child: Text(
          goalFailureMessage(context, failure),
...
class GoalReadOnlyActionField extends StatelessWidget {
  const GoalReadOnlyActionField({
    super.key,
    required this.label,
    required this.value,
