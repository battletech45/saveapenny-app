...
class _AccountFormSheetState extends ConsumerState<AccountFormSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppSheetScaffold(
      title: _isEditing ? l10n.accountsEditTitle : l10n.accountsCreateTitle,
      subtitle: _isEditing
          ? l10n.accountsEditSubtitle
          : l10n.accountsCreateSubtitle,
      failure: failure == null ? null : _SheetFailureNotice(failure: failure),
          ...
          children: <Widget>[
            ...
            AppDropdownField<AccountType>(
              ...
              options: AccountType.values
                  .map(
                    (type) => AppDropdownOption<AccountType>(
                      value: type,
