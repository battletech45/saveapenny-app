    ...
    return AppSheetScaffold(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: <Widget>[
            AppDropdownField<RecurringTransactionType>(
              label: l10n.recurringTransactionsTypeLabel,
              value: _type,
              options: <AppDropdownOption<RecurringTransactionType>>[
                AppDropdownOption<RecurringTransactionType>(
                  value: RecurringTransactionType.income,
                  label: l10n.recurringTransactionsTypeIncome,
                  icon: Icons.add_circle_outline_rounded,
                ),
                AppDropdownOption<RecurringTransactionType>(
                  value: RecurringTransactionType.expense,
                  label: l10n.recurringTransactionsTypeExpense,
            ...
            AppDropdownField<String>(
              label: l10n.recurringTransactionsAccountLabel,
              value: _accountId,
            ...
            AppDropdownField<String>(
              ...
              value: categories.any((category) => category.id == _categoryId)
                  ? _categoryId
                  : null,
              label: l10n.recurringTransactionsCategoryLabel,
            ...
            AppDropdownField<RecurringFrequency>(
              label: l10n.recurringTransactionsFrequencyLabel,
              value: _frequency,
              options: <AppDropdownOption<RecurringFrequency>>[
                AppDropdownOption<RecurringFrequency>(
                  value: RecurringFrequency.daily,
                  label: l10n.recurringTransactionsFrequencyDaily,
                ),
                AppDropdownOption<RecurringFrequency>(
                  value: RecurringFrequency.weekly,
                  label: l10n.recurringTransactionsFrequencyWeekly,
                ),
                AppDropdownOption<RecurringFrequency>(
                  value: RecurringFrequency.monthly,
                  label: l10n.recurringTransactionsFrequencyMonthly,
                ),
                AppDropdownOption<RecurringFrequency>(
                  value: RecurringFrequency.yearly,
                  label: l10n.recurringTransactionsFrequencyYearly,
                ),
              ],
              onChanged: _isSubmitting
                  ? null
            ...
            if (widget.advancedRecurringUnlocked) ...<Widget>[
              ...
              const SizedBox(height: AppSpacing.lg),
              AppDropdownField<RecurringClassification?>(
                label: l10n.recurringTransactionsClassificationLabel,
                value: _classification,
                options: <AppDropdownOption<RecurringClassification?>>[
                  AppDropdownOption<RecurringClassification?>(
                    value: null,
                    label: l10n.recurringTransactionsClassificationNone,
                  ),
                  ...RecurringClassification.values.map(
                    (value) => AppDropdownOption<RecurringClassification?>(
                      value: value,
                      label: recurringClassificationLabel(l10n, value),
                    ),
                  ),
                ],
                onChanged: _isSubmitting
